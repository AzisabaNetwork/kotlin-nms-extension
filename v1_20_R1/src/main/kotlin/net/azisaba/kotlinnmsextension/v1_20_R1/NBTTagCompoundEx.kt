...
operator fun NBTTagCompound.set(key: String, value: List<Long>) = c(key, value)
...
operator fun NBTTagCompound.set(key: String, value: List<Int>) = b(key, value)
...
operator fun NBTTagCompound.set(key: String, value: List<Byte>) = a(key, value)
